...
<head>
    ...
    <meta name="description" content="Temukan tempat diskusi terbaik untuk pelajar, mahasiswa, dan pemuda/i" />
    <meta name="author" content="Pojok Diskusi" />
    <title>Pojok Diskusi</title>
    <!-- Favicon-->
            ...
            <div class="row mt-2">
                <div class="col text-center">
                    <small class="text-muted">
                        <a href="#" class="text-muted">Cookie Statement</a> |
